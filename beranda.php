    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong><marquee>SISTEM INFORMASI PENCATATAN BARANG MASUK PADA PT.PELINDO 1 (PERSERO)</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="20%">ID Barang Masuk</th><th>Nama Kapal</th><th><center>Jenis Barang </center></th><th>Jumlah Barang</th><th>Tanggal Masuk</th>
                            </tr>
                        </thead>
                        <tbody>
