...
<html>
    <head>
        <title>Cetak Data Barang Pertahun</title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="">
                        ...
                        <b><center><h4><u>DATA LAPORAN PERTAHUN   <? echo "$bulanNama $ambilthn"; ?></u></h4></center></b><br>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tbl_barangmasuk WHERE substr(tgl_masuk,1,4)='$ambilthn'";
